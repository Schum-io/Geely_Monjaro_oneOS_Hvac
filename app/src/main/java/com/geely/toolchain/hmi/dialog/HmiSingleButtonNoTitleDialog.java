...
public class HmiSingleButtonNoTitleDialog extends BaseDialog {
    ...
    public interface BtnClickListener2 {
        void action(HmiSingleButtonNoTitleDialog dialog);
    }

    public HmiSingleButtonNoTitleDialog(Context context) {
        super(context);
    }
    ...
    private void initView(Window window) {
        ...
        this.mButton.setOnClickListener(new View.OnClickListener() { // from class: com.geely.toolchain.hmi.dialog.-$$Lambda$HmiSingleButtonNoTitleDialog$UZ6gRD-xys7nTVv082qaz5iSEf0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                HmiSingleButtonNoTitleDialog.this.lambda$initView$0$HmiSingleButtonNoTitleDialog(view);
            }
        });
    }

    public /* synthetic */ void lambda$initView$0$HmiSingleButtonNoTitleDialog(View view) {
    ...
    public HmiSingleButtonNoTitleDialog setContent(String content) {
        this.mContentText = content;
        return this;
    }

    public HmiSingleButtonNoTitleDialog setButtonText(String text) {
        this.mButtonText = text;
        return this;
    }

    @Deprecated
    public HmiSingleButtonNoTitleDialog setBtnClickListener(BtnClickListener btnClickListener) {
        this.mBtnClickListener = btnClickListener;
        return this;
    }

    public HmiSingleButtonNoTitleDialog setBtnClickListener2(BtnClickListener2 btnClickListener) {
