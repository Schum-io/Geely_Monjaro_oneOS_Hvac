...
public class HmiAddCustomViewNoButtonMediumDialog extends BaseHmiDialogFragment {
    ...
    protected int setLayoutId() {
        return R.layout.hmi_add_custom_view_no_button_medium_dialog;
    }
    ...
    private void initView(View view) {
        ...
        this.mCloseIcon.setOnClickListener(new View.OnClickListener() { // from class: com.geely.toolchain.hmi.dialog.-$$Lambda$HmiAddCustomViewNoButtonMediumDialog$zEg2edpOCQafXeu58iDPSkyX8Ss
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                HmiAddCustomViewNoButtonMediumDialog.this.lambda$initView$0$HmiAddCustomViewNoButtonMediumDialog(view2);
            }
        });
    }

    public /* synthetic */ void lambda$initView$0$HmiAddCustomViewNoButtonMediumDialog(View view) {
    ...
    public HmiAddCustomViewNoButtonMediumDialog setHmiAddView(View view) {
        Log.i(this.TAG, "setHmiAddView: view = " + view);
        this.hmiView = view;
        return this;
    }

    public HmiAddCustomViewNoButtonMediumDialog setHmiTitle(String title) {
        Log.i(this.TAG, "setHmiTitle: title = " + title);
        this.hmiTitle = title;
        return this;
    }

    public HmiAddCustomViewNoButtonMediumDialog setHmiCloseResourceId(int closeResourceId) {
        Log.i(this.TAG, "setHmiCloseResourceId: closeResourceId = " + closeResourceId);
        this.hmiCloseResourceId = closeResourceId;
        return this;
    }

    public HmiAddCustomViewNoButtonMediumDialog setHmiCloseListener(HmiCloseListener hmiCloseListener) {
