...
public class NaviResultCode {
    ...
    public static final int RESULT_NO_ALTERNATIVE_ROUTE = 10084;
    ...
    static {
        ...
        sparseArray.put(-2, "未知错误");
        sparseArray.put(0, "成功");
        sparseArray.put(1001, "地图未安装");
        sparseArray.put(RESULT_NEED_USER_CONFIRM, "需要用户确认");
        sparseArray.put(1000, "无权进行此操作");
        sparseArray.put(1002, "请求超时");
        sparseArray.put(1003, "没有历史目的地数据");
        sparseArray.put(RESULT_OK, "请求成功");
        sparseArray.put(RESULT_PARAM_ERROR, "非法参数");
        ...
        sparseArray.put(RESULT_UNSUPPORT_VIEW, "不支持的视图");
        ...
        sparseArray.put(RESULT_AUTO_NO_LAUNCH, "Auto未启动");
        ...
        sparseArray.put(RESULT_LISTENER_NULL, "监听为空");
        sparseArray.put(RESULT_FAIL, "请求失败");
        sparseArray.put(RESULT_EXECUTE_CANCLE, "执行动作取消");
        sparseArray.put(RESULT_SET_HOME_SUCCESS, "设置家成功");
        sparseArray.put(RESULT_SET_COMPANY_SUCCESS, "设置公司成功");
        sparseArray.put(RESULT_SET_FAVORITE_SUCCESS, "设置普通收藏点成功");
        sparseArray.put(RESULT_ALREADY_SET_MUTE, "执行失败,当前已静音");
        sparseArray.put(RESULT_ALREADY_RECOVERY_MUTE, "执行失败,当前已恢复音量");
        sparseArray.put(RESULT_FAILED_BY_GPS_LOCATION, "GPS定位失败");
        sparseArray.put(RESULT_FAILED_BY_REQUEST_FREQUENTLY, "请求过于频繁");
        sparseArray.put(RESULT_FAILED_BY_REFRESH_ROUTE, "路线更新失败");
        sparseArray.put(RESULT_NO_PARKING_DATA, "没有停车场数据");
        sparseArray.put(RESULT_AVOID_LINE_RESTRICTION_FAIL, "开启避开限行失败未设置车牌号");
        sparseArray.put(RESULT_SET_STRATEGY_FAIL, "重复偏好设置");
        sparseArray.put(RESULT_DELETE_WAYPOINT_FAIL, "存在自动添加的途经点无法删除");
        sparseArray.put(RESULT_SWITCH_ROADS_NO_NAVI_FAIL, "当前不在导航中无法切换主辅路");
        sparseArray.put(RESULT_NO_ROADS_DISTINGUISH, "没有主辅路区分");
        sparseArray.put(RESULT_SWITCH_ROADS_FAIL, "主辅路切换失败");
        sparseArray.put(RESULT_SWITCH_BRIDGE_STATUS_NO_NAVI_FAIL, "当前不在导航中无法切换桥上桥下");
        sparseArray.put(RESULT_NO_BRIDGE_STATUS, "没有桥上桥下");
        sparseArray.put(RESULT_SWITCH_BRIDGE_STATUS_FAIL, "桥上桥下切换失败");
        sparseArray.put(RESULT_SAME_START_END_POINTS, "起终点相同");
        sparseArray.put(RESULT_NO_SET_HOME_AND_COMPANY, "未设置家和公司");
        sparseArray.put(RESULT_NO_FAVORITE, "暂无收藏夹内容");
        sparseArray.put(RESULT_SERVICE_RELEASE, "断开导航服务");
        sparseArray.put(RESULT_ON_NAVI_ERROR, "导航中无法进行操作");
        sparseArray.put(RESULT_NO_ALTERNATIVE_ROUTE, "当前没有备选路线");
    }
