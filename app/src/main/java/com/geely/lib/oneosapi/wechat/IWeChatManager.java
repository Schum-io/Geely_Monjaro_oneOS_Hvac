...
public interface IWeChatManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWeChatManager {
        ...
        public static final int TRANSACTION_getWeChatVoipState = 1;

        public static class Proxy implements IWeChatManager {
        ...
        public static IWeChatManager asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IWeChatManager)) ? new Proxy(obj) : (IWeChatManager) iInterfaceQueryLocalInterface;
        }
