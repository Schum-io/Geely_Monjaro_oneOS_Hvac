...
public class ServiceConnectionConstant {
    public static final int SERVICE_TYPE_APPSTORE_MANAGER = 29;
    ...
    public static final int SERVICE_TYPE_DOCKBAR_MANAGER = 21;
    public static final int SERVICE_TYPE_GESTURE_MANAGER = 23;
    public static final int SERVICE_TYPE_KEY_INPUT = 8;
    public static final int SERVICE_TYPE_LAUNCHER_MANAGER = 22;
    public static final int SERVICE_TYPE_LINK_MANAGER = 19;
    ...
    public static final int SERVICE_TYPE_OTA = 28;
    public static final int SERVICE_TYPE_PAYMENT_MANAGER = 24;
    ...
    public static final int SERVICE_TYPE_SHORTCUT_MANAGER = 20;
    ...
    public static final int SERVICE_TYPE_WECHAT_MANAGER = 27;
}
