...
public interface ITryConnectCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITryConnectCallback {
        ...
        public static final int TRANSACTION_denied = 2;
        public static final int TRANSACTION_permitted = 1;

        public static class Proxy implements ITryConnectCallback {
        ...
        public static ITryConnectCallback asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ITryConnectCallback)) ? new Proxy(obj) : (ITryConnectCallback) iInterfaceQueryLocalInterface;
        }
