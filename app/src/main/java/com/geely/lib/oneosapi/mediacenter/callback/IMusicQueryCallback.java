...
public interface IMusicQueryCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMusicQueryCallback {
        ...
        public static class Proxy implements IMusicQueryCallback {
        ...
        public static IMusicQueryCallback asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMusicQueryCallback)) ? new Proxy(obj) : (IMusicQueryCallback) iInterfaceQueryLocalInterface;
        }
