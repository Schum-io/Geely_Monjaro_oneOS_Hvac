...
public interface IWeatherAPICallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWeatherAPICallback {
        ...
        public static class Proxy implements IWeatherAPICallback {
        ...
        public static IWeatherAPICallback asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IWeatherAPICallback)) ? new Proxy(obj) : (IWeatherAPICallback) iInterfaceQueryLocalInterface;
        }
