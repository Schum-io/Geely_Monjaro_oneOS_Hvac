...
public interface IBtStateChangeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBtStateChangeListener {
        ...
        public static final int TRANSACTION_onBtProfileChange = 1;

        public static class Proxy implements IBtStateChangeListener {
        ...
        public static IBtStateChangeListener asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IBtStateChangeListener)) ? new Proxy(obj) : (IBtStateChangeListener) iInterfaceQueryLocalInterface;
        }
