...
public interface IPhonebookDownloadStateListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPhonebookDownloadStateListener {
        ...
        public static final int TRANSACTION_onDownloadStateListener = 1;

        public static class Proxy implements IPhonebookDownloadStateListener {
        ...
        public static IPhonebookDownloadStateListener asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPhonebookDownloadStateListener)) ? new Proxy(obj) : (IPhonebookDownloadStateListener) iInterfaceQueryLocalInterface;
        }
