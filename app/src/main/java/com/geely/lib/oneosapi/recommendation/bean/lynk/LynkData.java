...
public class LynkData implements Parcelable {
    public static final Creator<LynkData> CREATOR = new Creator<LynkData>() { // from class: com.geely.lib.oneosapi.recommendation.bean.lynk.LynkData.1
