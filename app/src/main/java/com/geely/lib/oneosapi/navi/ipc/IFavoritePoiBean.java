...
public class IFavoritePoiBean implements Parcelable {
    public static final Creator<IFavoritePoiBean> CREATOR = new Creator<IFavoritePoiBean>() { // from class: com.geely.lib.oneosapi.navi.ipc.IFavoritePoiBean.1
    ...
    public IFavoritePoiBean(Parcel in) {
        this.favoriteType = in.readInt();
        this.name = in.readString();
        this.uid = in.readString();
        this.distance = in.readInt();
