...
public interface ISweepingRobotInfo extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISweepingRobotInfo {
        ...
        public static final int TRANSACTION_getEnergyValue = 2;
        public static final int TRANSACTION_getId = 3;
        public static final int TRANSACTION_getSwitchOpen = 1;

        public static class Proxy implements ISweepingRobotInfo {
        ...
        public static ISweepingRobotInfo asInterface(IBinder obj) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ISweepingRobotInfo)) ? new Proxy(obj) : (ISweepingRobotInfo) iInterfaceQueryLocalInterface;
        }
