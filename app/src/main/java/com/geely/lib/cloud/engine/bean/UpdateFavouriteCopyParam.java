...
public class UpdateFavouriteCopyParam implements Parcelable {
    public static final Creator<UpdateFavouriteCopyParam> CREATOR = new Creator<UpdateFavouriteCopyParam>() { // from class: com.geely.lib.cloud.engine.bean.UpdateFavouriteCopyParam.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public UpdateFavouriteCopyParam createFromParcel(Parcel in) {
            return new UpdateFavouriteCopyParam(in);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public UpdateFavouriteCopyParam[] newArray(int size) {
            return new UpdateFavouriteCopyParam[size];
        }
    };
    ...
    public UpdateFavouriteCopyParam() {
    }
    ...
    protected UpdateFavouriteCopyParam(Parcel in) {
