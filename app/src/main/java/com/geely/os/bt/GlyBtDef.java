...
public class GlyBtDef {
    ...
    public static final int BT_AVRCP_PLAY_POS_BACKWARD = 2;
    public static final int BT_AVRCP_PLAY_POS_FORWARD = 1;
    public static final int BT_AVRCP_PLAY_STATE_PAUSE = 2;
    public static final int BT_AVRCP_PLAY_STATE_PLAY = 1;
    ...
    public static final int REASON_DOWNLOAD_NEW_MESSAGE_COMPLETED = 3;
