...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Comparator<Comparable>() { // from class: com.geely.livewallpager.lotties.parser.moshi.LinkedHashTreeMap.1
    ...
    LinkedHashTreeMap(Comparator<? super K> comparator) {
        this.size = 0;
        this.modCount = 0;
        this.comparator = comparator == null ? (Comparator) NATURAL_ORDER : comparator;
    ...
    public V get(Object key) {
        Node<K, V> nodeFindByObject = findByObject(key);
    ...
    public V put(K key, V value) {
        ...
        Node<K, V> nodeFind = find(key, true);
        V v = nodeFind.value;
        nodeFind.value = value;
        return v;
    }
    ...
    public V remove(Object key) {
        Node<K, V> nodeRemoveInternalByKey = removeInternalByKey(key);
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> replacement) {
        ...
        int i = node.hash;
        this.table[i & (this.table.length - 1)] = replacement;
    }
    ...
    private void rebalance(Node<K, V> unbalanced, boolean insert) {
        while (unbalanced != null) {
            ...
            int i = node != null ? node.height : 0;
            int i2 = node2 != null ? node2.height : 0;
            int i3 = i - i2;
            if (i3 == -2) {
                Node<K, V> node3 = node2.left;
                Node<K, V> node4 = node2.right;
                int i4 = (node3 != null ? node3.height : 0) - (node4 != null ? node4.height : 0);
                if (i4 == -1 || (i4 == 0 && !insert)) {
                ...
                Node<K, V> node5 = node.left;
                Node<K, V> node6 = node.right;
                int i5 = (node5 != null ? node5.height : 0) - (node6 != null ? node6.height : 0);
                if (i5 == 1 || (i5 == 0 && !insert)) {
    ...
    static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] oldTable) {
        ...
        Node<K, V>[] nodeArr = new Node[length * 2];
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (node != null) {
                ...
                nodeArr[i] = i2 > 0 ? avlBuilder.root() : null;
                nodeArr[i + length] = i3 > 0 ? avlBuilder2.root() : null;
            }
        }
        return nodeArr;
    }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return new LinkedTreeMapIterator<Entry<K, V>>() { // from class: com.geely.livewallpager.lotties.parser.moshi.LinkedHashTreeMap.EntrySet.1
                {
        ...
        public boolean remove(Object o) {
            ...
            if (!(o instanceof Map.Entry) || (nodeFindByEntry = LinkedHashTreeMap.this.findByEntry((Entry) o)) == null) {
                return false;
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedTreeMapIterator<K>() { // from class: com.geely.livewallpager.lotties.parser.moshi.LinkedHashTreeMap.KeySet.1
                {
                    LinkedHashTreeMap linkedHashTreeMap = LinkedHashTreeMap.this;
                }
