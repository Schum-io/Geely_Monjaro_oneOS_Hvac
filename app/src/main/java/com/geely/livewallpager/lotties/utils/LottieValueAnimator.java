...
public class LottieValueAnimator extends BaseLottieAnimator implements Choreographer.FrameCallback {
    ...
    public void doFrame(long frameTimeNanos) {
        ...
        float frameDurationNs = (this.lastFrameTimeNs != 0 ? frameTimeNanos - this.lastFrameTimeNs : 0L) / getFrameDurationNs();
        float f = this.frame;
        if (isReversed()) {
    ...
    public void setMinAndMaxFrames(float minFrame, float maxFrame) {
        ...
        this.minFrame = MiscUtils.clamp(minFrame, startFrame, endFrame);
        this.maxFrame = MiscUtils.clamp(maxFrame, startFrame, endFrame);
