...
public abstract class JsonReader implements Closeable {
    ...
    public static final class Options {
        ...
        public static Options of(String... strings) {
            try {
                ByteString[] byteStringArr = new ByteString[strings.length];
                ...
                return new Options((String[]) strings.clone(), okio.Options.of(byteStringArr));
            } catch (IOException e) {
    ...
    */
    public static void string(okio.BufferedSink r7, String r8) throws IOException {
        /*
            java.lang.String[] r0 = com.geely.livewallpager.lotties.parser.moshi.JsonReader.REPLACEMENT_CHARS
            r1 = 34
            r7.writeByte(r1)
            int r2 = r8.length()
            r3 = 0
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.geely.livewallpager.lotties.parser.moshi.JsonReader.string(okio.BufferedSink, java.lang.String):void");
    }
}
