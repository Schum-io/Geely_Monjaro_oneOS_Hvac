...
final class JsonUtf8Reader extends JsonReader {
    ...
    @Override // com.geely.livewallpager.lotties.parser.moshi.JsonReader
    ...
    private int peekNumber() throws IOException {
        ...
        int c3 = 0;
        boolean z2 = false;
        long j2 = MIN_INCOMPLETE_INTEGER;
        while (true) {
            long j3 = i3 + 1;
        ...
        if (isLiteral(this.buffer.getByte(i3))) {
            return 0;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x007f, code lost:
        ...
        return r1;
     */
    private int nextNonWhitespace(boolean r7) throws IOException {
        /*
            r6 = this;
            r0 = 0
        L1:
        ...
        L6d:
            ...
            com.geely.livewallpager.lotties.parser.moshi.JsonEncodingException r7 = r6.syntaxError(r7)
            throw r7
        L74:
            r2 = 35
            if (r1 != r2) goto L7f
        ...
        L86:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.geely.livewallpager.lotties.parser.moshi.JsonUtf8Reader.nextNonWhitespace(boolean):int");
    }
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        ...
        Buffer buffer = this.buffer;
        buffer.skip(z ? jIndexOf + CLOSING_BLOCK_COMMENT.size() : buffer.size());
        return z;
    }
