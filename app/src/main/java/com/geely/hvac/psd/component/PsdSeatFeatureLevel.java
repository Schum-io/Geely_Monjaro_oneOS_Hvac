...
import com.geely.hvac.databinding.PsdSeatFeatureLevelBinding;
...
public abstract class PsdSeatFeatureLevel extends TrackballConstraintLayout {
    private static final String TAG = "PsdSeatFeatureLevel";
    private String mAnimatePath;
    private PsdSeatFeatureLevelBinding mBinding;
    ...
    public PsdSeatFeatureLevel(Context context) {
        super(context);
    ...
    public PsdSeatFeatureLevel(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mEnable = new ObservableBoolean(true);
        this.mLevel = 0;
        this.mViewFroze = new ViewFroze(ViewFroze.FROZE_TIME);
    ...
    public PsdSeatFeatureLevel(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static void bindSeatFeatureLevelEnable(PsdSeatFeatureLevel v, boolean enable) {
        Log.d(TAG, "bindSeatFeatureLevelEnable, enable:" + enable);
        v.setEnabled(enable);
    }

    public static void bindSeatFeatureLevelLevel(PsdSeatFeatureLevel v, int level) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        PsdSeatFeatureLevelBinding psdSeatFeatureLevelBindingInflate = PsdSeatFeatureLevelBinding.inflate(LayoutInflater.from(context), this, true);
        this.mBinding = psdSeatFeatureLevelBindingInflate;
        psdSeatFeatureLevelBindingInflate.setView(this);
        ...
        this.mBinding.disableBg.setNormalColor(getResources().getColor(R.color.seat_heat_status_bg_disable));
    ...
    private void updateAnimate() {
        if (this.mEnable.get()) {
            ...
            LogUtil.d(TAG, "updateAnimate, attach:" + isAttachedToWindow());
