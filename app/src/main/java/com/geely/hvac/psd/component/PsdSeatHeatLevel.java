...
public class PsdSeatHeatLevel extends PsdSeatFeatureLevel {
    ...
    public PsdSeatHeatLevel(Context context) {
        super(context);
    }

    public PsdSeatHeatLevel(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PsdSeatHeatLevel(Context context, AttributeSet attrs, int defStyleAttr) {
