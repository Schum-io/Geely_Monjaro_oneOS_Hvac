...
public class PsdSeatVentilateLevel extends PsdSeatFeatureLevel {
    ...
    public PsdSeatVentilateLevel(Context context) {
        super(context);
    }

    public PsdSeatVentilateLevel(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PsdSeatVentilateLevel(Context context, AttributeSet attrs, int defStyleAttr) {
